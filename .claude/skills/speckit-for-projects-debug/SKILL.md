---
name: speckit-for-projects-debug
description: Fix a bug and synchronize impacted design artifacts and task ledgers.
metadata:
  command: /sdd.debug
  source: .specify/templates/commands/debug.md
---
