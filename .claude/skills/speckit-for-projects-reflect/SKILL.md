---
name: speckit-for-projects-reflect
description: Synchronize design artifacts and task ledgers to the current working tree diff.
metadata:
  command: /sdd.reflect
  source: .specify/templates/commands/reflect.md
---
