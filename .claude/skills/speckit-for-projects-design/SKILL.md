---
name: speckit-for-projects-design
description: Create or overwrite one specific design bundle and review changes with git diff.
metadata:
  command: /sdd.design
  source: .specify/templates/commands/design.md
---
